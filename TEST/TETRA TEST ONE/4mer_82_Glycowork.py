...
while((rowSkip) < maxRow):
    ...
    tetramer = ['GlcA(b1-3)Xyl(a1-3)GlcA(b1-3)Xyl(a1-3)GlcA(b1-3)Xyl(a1-3)GlcA(b1-3)Xyl'] #4MER
    ...
    for index, rows in file_input.iterrows():
        ...
        outprint_multi_protein.at[a, 'preds'] = str((get_lectin_preds((rows['SEQUENCE']), tetramer,model,protein_dict))['pred'])
        a +=1
    ...
    outPreds = (f"/ddnA/project/jjung1/pvalle6/preds/tetramer_34.csv")
